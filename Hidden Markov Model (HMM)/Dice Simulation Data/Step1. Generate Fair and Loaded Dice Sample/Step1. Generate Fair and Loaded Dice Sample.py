...
def InitialState(pi_0=0.5):
    ...
    ''' 
    S_0 = np.random.choice(2, 1, p=[pi_0, 1-pi_0])[0]
    return S_0
...
Sample_Hid, Sample_Obs  = GenerateFLDice (N, p01, p10, pL, pF, Dice, pi_0, seed)
#or equal to below:
#Sample_Hid, Sample_Obs = GenerateFLDice (N=N, p01=p01, p10=p10, pL=pL, seed=seed)

Sample_Hid  = pd.Series(Sample_Hid, name = 'Observation')
Sample_Obs = pd.Series(Sample_Obs, name = 'State')
